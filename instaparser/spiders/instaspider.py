...
class InstaspiderSpider(scrapy.Spider):
    ...
    inst_login = 'ddbbm7rkmqsy'
    inst_pwd = 'PWD_INSTAGRAM_BROWSER:10:1658655881:Aa5QALYRZIwA+cXyGf6BMK7cICZlxnE9a2KuJ25+8//2dUQkfBSjwDSrI/64crYf+vw4F4XPuBNdpeHNi0LUFtGNwFBeVQTWrATRtiL2+Hdiad0fV2TOoexhTb5vP8YjmlyKZsZZLrIWwTY='

    user_for_parse = 'zeitimbild'
